...
import { createSessionMeshTool, isRecord, optionalString } from './common.js'
...
export function buildCreateSessionTool(runtime) {
  return createSessionMeshTool({
    ...
    parse: parseCreateSessionArgs,
    run(args, exec) {
      return runtime.createSession(args, exec.agent, exec.signal)
    },
  })
}
